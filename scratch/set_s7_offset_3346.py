...
# Step 3: Write Reg 31 = 3346 (0x0D12 -> L: 0x12, H: 0x0D)
val = 3346
vl = val & 0xFF
vh = (val >> 8) & 0xFF
...
with sftp.file('/tmp/test_offset_3346.py', 'w') as f:
    f.write(py_script)
sftp.close()

stdin, stdout, stderr = client.exec_command('/home/user/so101/.venv/bin/python /tmp/test_offset_3346.py')
