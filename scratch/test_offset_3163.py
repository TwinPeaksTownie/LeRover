...
# Step 3: Test Reg 31 = 3163 (0x0C5B -> L: 0x5B, H: 0x0C)
val = 3163
vl = val & 0xFF
vh = (val >> 8) & 0xFF
...
with sftp.file('/tmp/test_offset.py', 'w') as f:
    f.write(py_script)
sftp.close()

stdin, stdout, stderr = client.exec_command('/home/user/so101/.venv/bin/python /tmp/test_offset.py')
